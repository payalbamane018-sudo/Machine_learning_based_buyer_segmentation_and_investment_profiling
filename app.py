...
st.sidebar.warning(
    "**total_investment, avg_purchase_price, properties_owned and "
    "buying_tenure_years are SYNTHETIC** - generated to illustrate the "
    "dashboard, since the source data has no real financial fields. "
    "All other fields (demographics, loan status, acquisition purpose, "
    "geography) are real client data."
)

segment_filter = st.sidebar.multiselect(
    "Filter by segment", SEGMENT_ORDER, default=SEGMENT_ORDER
)
view = df[df["segment"].isin(segment_filter)]
